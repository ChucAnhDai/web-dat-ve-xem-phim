...
const moviesData = [
  ...
  {title:'Shadow Protocol',cat:'Thriller',dur:'125 min',release:'2026-02-28',rating:4.3,status:'Now Showing',emoji:'🕵️'},
  ...
  document.getElementById('moviesBody').innerHTML = data.map(m => `
    <tr>
      ...
      <td><div class="actions-row">
        ...
        <button class="action-btn gold" title="Add Showtime" onclick="window.location.href='<?php echo htmlspecialchars($appBase); ?>/admin/showtimes'">
