  ...
  <div class="header-right">
    ...
    <div style="position:relative;">
      ...
      <div class="profile-drop" id="profileDrop">
        ...
        <a href="<?php echo htmlspecialchars($appBase); ?>/admin/users" class="profile-drop-item">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20 21v-2a4 4 0 00-4-4H8a4 4 0 00-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
          My Profile
        </a>
        <a href="<?php echo htmlspecialchars($appBase); ?>/admin" class="profile-drop-item">
        ...
        <div class="profile-drop-sep"></div>
        <a href="#" class="profile-drop-item" style="color:var(--red);" onclick="showToast('Signed out','info');return false;">
